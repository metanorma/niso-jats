...
RSpec.describe Niso::Jats::Article do
  ...
  context "with niso-jats/archiving/0.4/Smallsamples/samplesmall-archive0-oasis.xml" do
    let(:fixture) { file_fixture("niso-jats/archiving/0.4/Smallsamples/samplesmall-archive0-oasis.xml") }
    it_behaves_like "a serializer"
  end

  context "with niso-jats/archiving/0.4/Smallsamples/samplesmall-archive0.xml" do
  ...
  context "with niso-jats/archiving/1.1d3/Smallsamples/sample-archive-oasis-and-html1-mathml3.xml" do
    let(:fixture) { file_fixture("niso-jats/archiving/1.1d3/Smallsamples/sample-archive-oasis-and-html1-mathml3.xml") }
    it_behaves_like "a serializer"
  end

  context "with niso-jats/archiving/1.1d3/Smallsamples/sample-archive-oasis-and-html1.xml" do
    let(:fixture) { file_fixture("niso-jats/archiving/1.1d3/Smallsamples/sample-archive-oasis-and-html1.xml") }
    it_behaves_like "a serializer"
  end

  context "with niso-jats/archiving/1.1d3/Smallsamples/sample-archive-oasis-table1.xml" do
    let(:fixture) { file_fixture("niso-jats/archiving/1.1d3/Smallsamples/sample-archive-oasis-table1.xml") }
    it_behaves_like "a serializer"
  end

  context "with niso-jats/archiving/1.1d3/Smallsamples/samplesmall-archive1-mathml.xml" do
    let(:fixture) { file_fixture("niso-jats/archiving/1.1d3/Smallsamples/samplesmall-archive1-mathml.xml") }
    it_behaves_like "a serializer"
  end

  context "with niso-jats/archiving/1.1d3/Smallsamples/samplesmall-archive1-mathml3-bad.xml" do
    let(:fixture) { file_fixture("niso-jats/archiving/1.1d3/Smallsamples/samplesmall-archive1-mathml3-bad.xml") }
    it_behaves_like "a serializer"
  end

  context "with niso-jats/archiving/1.1d3/Smallsamples/samplesmall-archive1-mathml3.xml" do
    let(:fixture) { file_fixture("niso-jats/archiving/1.1d3/Smallsamples/samplesmall-archive1-mathml3.xml") }
    it_behaves_like "a serializer"
  end

  context "with niso-jats/archiving/1.1d3/Smallsamples/samplesmall-archive1.xml" do
    let(:fixture) { file_fixture("niso-jats/archiving/1.1d3/Smallsamples/samplesmall-archive1.xml") }
    it_behaves_like "a serializer"
  end

  context "with niso-jats/articleauthoring/0.4/Smallsamples/samplesmall-auth0.xml" do
    let(:fixture) { file_fixture("niso-jats/articleauthoring/0.4/Smallsamples/samplesmall-auth0.xml") }
    it_behaves_like "a serializer"
  end

  context "with niso-jats/articleauthoring/0.4/Smallsamples/samplesmall-base0.xml" do
  ...
  context "with niso-jats/publishing/0.4/Smallsamples/samplesmall-pub0-oasis.xml" do
    let(:fixture) { file_fixture("niso-jats/publishing/0.4/Smallsamples/samplesmall-pub0-oasis.xml") }
    it_behaves_like "a serializer"
  end

  context "with niso-jats/publishing/0.4/Smallsamples/samplesmall-pub0.xml" do
